...
class AsyncResults(models.Model):
  ...
  location = models.CharField(blank=False, max_length=400, null=False, default='None', db_index=True)
  filename = models.CharField(blank=False, max_length=255, null=False, default='None', db_index=True)
